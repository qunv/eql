...
func eqlparserParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 27, 98, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		18, 20, 22, 24, 0, 4, 1, 0, 1, 2, 1, 0, 3, 4, 1, 0, 15, 16, 1, 0, 17, 23,
		...
		19, 1, 0, 0, 0, 80, 81, 5, 25, 0, 0, 81, 82, 5, 24, 0, 0, 82, 21, 1, 0,
		0, 0, 83, 85, 5, 2, 0, 0, 84, 83, 1, 0, 0, 0, 84, 85, 1, 0, 0, 0, 85, 86,
		1, 0, 0, 0, 86, 87, 5, 24, 0, 0, 87, 23, 1, 0, 0, 0, 88, 96, 3, 22, 11,
...
func (p *EqlParser) Program() (localctx IProgramContext) {
	...
	for ok := true; ok; ok = ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&67076132) != 0) {
		{
			p.SetState(26)
			p.Statement()
		}
...
func (p *EqlParser) Type_() (localctx ITypeContext) {
	...
	case EqlParserAVG, EqlParserADD, EqlParserDIVIDE, EqlParserMULTIPLY, EqlParserEQ, EqlParserCONCAT, EqlParserGT:
...
func (p *EqlParser) Operator() (localctx IOperatorContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&16646144) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func (p *EqlParser) Factor() (localctx IFactorContext) {
	...
	case EqlParserSUM, EqlParserABS, EqlParserAVG, EqlParserADD, EqlParserDIVIDE, EqlParserMULTIPLY, EqlParserEQ, EqlParserCONCAT, EqlParserGT:
		p.EnterOuterAlt(localctx, 3)
		{
			p.SetState(90)
			p.ActionSpec()
