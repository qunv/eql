...
public class EqlLexer extends Lexer {
	...
	public static final int
		...
		RANGE=22, SUM=23, ABS=24, AVG=25, ADD=26, DIVIDE=27, MULTIPLY=28, EQ=29, 
		CONCAT=30, GT=31, GTE=32, LAMBDA=33, LT=34, INT=35, DECIMAL=36, DIGIT=37, 
		STRING=38, IF=39, ALPHABET=40, IDENT=41, WS=42, EOS=43;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'+'", "'-'", "'/'", "'*'", "'('", "')'", "'{'", "'}'", "'['", 
			"']'", "'='", "';'", "':'", "','", "'.'", "'>'", "'<'", "'$'", "'TRUE'", 
			"'FALSE'", "'print'", "'range'", "'SUM'", "'ABS'", "'AVG'", "'ADD'", 
			"'DIVIDE'", "'MULTIPLY'", "'EQ'", "'CONCAT'", "'GT'", "'GTE'", "'LAMBDA'", 
			"'LT'", null, null, null, null, "'IF'"
		};
	}
