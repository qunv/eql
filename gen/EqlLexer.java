...
public class EqlLexer extends Lexer {
	...
	public static final int
		...
		GREATER_THAN=16, LESS_THAN=17, DOLAR=18, TRUE=19, FALSE=20, PRINT=21, 
		SUM=22, ABS=23, AVG=24, ADD=25, DIVIDE=26, MULTIPLY=27, EQ=28, CONCAT=29, 
		GT=30, GTE=31, LAMBDA=32, INT=33, DECIMAL=34, DIGIT=35, STRING=36, IF=37, 
		ALPHABET=38, IDENT=39, WS=40, EOS=41;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ADD", "DIVIDE", "MULTIPLY", "EQ", "CONCAT", "GT", "GTE", "LAMBDA", "INT", 
			"DECIMAL", "DIGIT", "STRING", "ESC_SEQ", "DIGITS", "IF", "ALPHABET", 
			"IDENT", "WS", "EOS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'+'", "'-'", "'/'", "'*'", "'('", "')'", "'{'", "'}'", "'['", 
			"']'", "'='", "';'", "':'", "','", "'.'", "'>'", "'<'", "'$'", "'TRUE'", 
			"'FALSE'", "'print'", "'SUM'", "'ABS'", "'AVG'", "'ADD'", "'DIVIDE'", 
			"'MULTIPLY'", "'EQ'", "'CONCAT'", "'GT'", "'GTE'", "'LAMBDA'", null, 
			null, null, null, "'IF'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LESS_THAN", "DOLAR", "TRUE", "FALSE", "PRINT", "SUM", "ABS", "AVG", 
			"ADD", "DIVIDE", "MULTIPLY", "EQ", "CONCAT", "GT", "GTE", "LAMBDA", "INT", 
			"DECIMAL", "DIGIT", "STRING", "IF", "ALPHABET", "IDENT", "WS", "EOS"
		};
	}
