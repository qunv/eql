...
public class EqlLexer extends Lexer {
	...
	public static final int
		...
		GREATER_THAN=16, LESS_THAN=17, TRUE=18, FALSE=19, PRINT=20, SUM=21, ABS=22, 
		AVG=23, ADD=24, DIVIDE=25, MULTIPLY=26, EQ=27, CONCAT=28, GT=29, GTE=30, 
		LAMBDA=31, INT=32, DECIMAL=33, DIGIT=34, STRING=35, IF=36, IDENTIFIER=37, 
		WS=38, EOS=39;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'EQ'", "'CONCAT'", "'GT'", "'GTE'", "'LAMBDA'", null, null, null, null, 
			"'IF'"
		};
	}
